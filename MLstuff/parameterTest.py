...
for i in range(len(est)):
    ...
    axs[i].set_title('N_estimaors = '+eststr,fontsize = 15)
...
plt.ylabel("Flux (1e-17erg/cm^2/s/Ang)",labelpad=25,fontsize = 15)
plt.xlabel("Wavelength (Angstrom)",labelpad = 10, fontsize = 15)
plt.title('max_depth = 6, alpha = 10', pad = 35, fontsize = 20)
plt.show()
